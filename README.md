...
**Hypothesis 2:** ในช่วง Weekend (วันหยุดสุดสัปดาห์) มีความต้องการเข้าพัก (Demand) สูงกว่า Weekday(วันธรรมดา) อย่างมีนัยสำคัญ
...
**Hypothesis 3:** ในช่วง Weekend (วันหยุดสุดสัปดาห์)โรงแรมจ่าย Commission OTA โดยไม่จำเป็นในวันที่ Demand สูงอยู่แล้ว
...
**Hypothesis 4:** การจองผ่าน Rate Code ประเภท Promotion บนช่องทาง OTA มีค่า Net ADR ต่ำที่สุด และอาจส่งผลให้ขาดทุน เมื่อเทียบกับต้นทุนการดำเนินงานของโรงแรม
