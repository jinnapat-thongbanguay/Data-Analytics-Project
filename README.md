...
- Method: วิเคราะห์ Net ADR โดยใช้ Rate Code ร่วมกับ Booking Channel เพื่อดูว่าเมื่อรวมส่วนลด (Discount) กับค่าคอมมิชชัน (Commission) แล้ว รายได้ที่เหลือจริงเป็นอย่างไร
- Goal: เพื่อประเมินความคุ้มค่าของโครงสร้างราคา และพิจารณาจำกัดสิทธิ์การใช้ Rate Code ประเภท Promotion เฉพาะในช่องทาง Direct Web เท่านั้น
